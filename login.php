...
<head>
    ...
    <title>TruthWhisper - Login</title>
                ...
                <div class="mx-auto max-w-xl">
                    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                        <div class="mx-auto w-full max-w-xl text-center">
                            ...
                            <h3 class="text-gray-500 my-2">Login to your account</h3>
                            <?php if (isset($_SESSION['error'])) : ?>
                                <div class="text-red-500 mb-4"><?php echo $_SESSION['error'];
                                                                unset($_SESSION['error']); ?></div>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['success'])) : ?>
                                <div class="text-green-500 mb-4"><?php echo $_SESSION['success'];
                        ...
                        <div class="mt-10 mx-auto w-full max-w-xl">
                            ...
                            <p class="mt-4 text-sm text-center text-gray-600">Don't have an account? <a href="register.php" class="text-indigo-600">Register</a></p>
                        </div>
                    </div>
                </div>
            </div>
